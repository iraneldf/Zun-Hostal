...
public class CambiarContrasennaDtoValidator : AbstractValidator<CambiarContrasennaInputDto>
{
    ...
    {
        RuleFor(m => m).Must((usuario, cancelacion) => usuario.NuevaContrasenna == usuario.ContrasennaConfirmada)
            .OverridePropertyName(nameof(CambiarContrasennaInputDto.NuevaContrasenna))
