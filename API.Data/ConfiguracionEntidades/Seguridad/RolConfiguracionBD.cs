...
public class RolConfiguracionBD
{
    public static void SetEntityBuilder(ModelBuilder modelBuilder)
    {
        ...
        List<Permiso> permisos = new()
        {
            new Permiso
            {
                Id = new Guid("56B3924B-209B-40FB-9F31-AD75C12F4528"), Nombre = "Listar usuarios",
                Descripcion = "Permite ver los usuarios existentes en el sistema y sus datos."
            },
            new Permiso
            {
                Id = new Guid("4129CF49-CC22-46A1-9625-501855F2DA8B"), Nombre = "Gestionar usuarios",
                Descripcion = "Permite ver, crear, modificar y eliminar usuarios en el sistema."
            },
            new Permiso
            {
                Id = new Guid("E36D283C-8B25-42B6-83BD-56EDD953E770"), Nombre = "Listar roles",
                Descripcion = "Permite ver los roles existentes en el sistema y sus datos."
            },
            new Permiso
            {
                Id = new Guid("90ABF232-A641-478D-8720-F0AE49E8A306"), Nombre = "Gestionar rol",
        ...
        IEnumerable<RolPermiso> listadoRolPermiso =
            permisos.Select(e => new RolPermiso { Id = e.Id, RolId = rol.Id, PermisoId = e.Id });
