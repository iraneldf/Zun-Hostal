...
public class UsuarioConfiguracionBD
{
    public static void SetEntityBuilder(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Usuario>().HasOne(e => e.Rol).WithMany(e => e.Usuarios).HasForeignKey(e => e.RolId)
        ...
        Usuario usuario = new()
        {
            Id = new Guid("42717FB8-6E3F-4C94-B6B1-A88E8718D0A6"), Nombre = "Admin", Apellidos = "System",
            Username = "admin.system", Correo = "admin.system@api.cu", Contrasenna = "poner hash",
