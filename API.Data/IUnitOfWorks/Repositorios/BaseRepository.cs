...
public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : EntidadBase
{
    ...
    {
        return await GetQuery(propiedadesIncluidas).ToListAsync();
    }

    public virtual async Task<List<TEntity>> GetAllAsync(Expression<Func<TEntity, bool>> condition,
        Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? propiedadesIncluidas = null)
    {
        return await GetQuery(propiedadesIncluidas).Where(condition).ToListAsync();
    }

    public virtual async Task<TEntity?> GetByIdAsync(Guid id,
        Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? propiedadesIncluidas = null)
    {
        return await GetQuery(propiedadesIncluidas).FirstOrDefaultAsync(e => e.Id == id);
    }
    ...
    public virtual async Task<TEntity?> LastAsync(
        Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? propiedadesIncluidas = null)
    {
        return await GetQuery(propiedadesIncluidas).LastOrDefaultAsync();
    }

    public virtual async Task<TEntity?> FirstAsync(Expression<Func<TEntity, bool>> condition,
        Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? propiedadesIncluidas = null)
    {
        return await GetQuery(propiedadesIncluidas).FirstOrDefaultAsync(condition);
    }

    public virtual async Task<TEntity?> LastAsync(Expression<Func<TEntity, bool>> condition,
        Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? propiedadesIncluidas = null)
    {
        return await GetQuery(propiedadesIncluidas).LastOrDefaultAsync(condition);
    }
